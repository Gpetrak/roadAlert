"""
Django settings for roadAlert project.
...
SECRET_KEY = '^%lfn08+=w^=80o6hfo^m9%t%s78hlq$^grsb5_e1xn2^!+qc*'
...
WSGI_APPLICATION = 'roadAlert.wsgi.application'
